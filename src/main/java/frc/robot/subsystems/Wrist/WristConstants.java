...
public class WristConstants {
    ...
    public static final double WRIST_POS_DEPLETE_CORAL_LEVEL0 = 3.8;
    ...
    public static final double WRIST_POS_TOLERANCE = 0.5;

    public static final double WRIST_POS_HOLD_ALGAE_NET = 7.15;
    public static final double THROW_ALGAE_NET = 8;
