...
public class HandlerTuning {
    ...
    private static final LoggedNetworkNumber CORAL_IN_DEBOUNCE_COUNTER_AUTO = new LoggedNetworkNumber("/Tuning/Handler/Coral Bounce Counter (Auto)", HandlerConstants.CORAL_IN_DEBOUNCE_COUNTER_AUTO);
    ...
    private static final LoggedNetworkNumber ALGAE_NET_IR_NOT_IN_VALUE = new LoggedNetworkNumber("/Tuning/Handler/Algae Net Not In Value", HandlerConstants.ALGAE_NET_IR_NOT_IN_VALUE);
    ...
    public static final double CORAL_IN_DEBOUNCE_COUNTER_AUTO_get() {
        return Constants.GetTuningMode() != TuningMode.IGNORE ? CORAL_IN_DEBOUNCE_COUNTER_AUTO.get() : HandlerConstants.CORAL_IN_DEBOUNCE_COUNTER_AUTO;
    }
    ...
    public static final double ALGAE_NET_IR_NOT_IN_VALUE_get() {
        return Constants.GetTuningMode() != TuningMode.IGNORE ? ALGAE_NET_IR_NOT_IN_VALUE.get() : HandlerConstants.ALGAE_NET_IR_NOT_IN_VALUE;
    }
}
