...
public class ElevatorConstants {
    ...
    public static final double ELEVATOR_POSE_INTAKE_CORAL = 0.7; //0
    ...
    public static final double ELEVATOR_POSE_ALGAE_HIGH = 11;
    public static final double ELEVATOR_POSE_ALGAE_IN_OFFSET = 2;
