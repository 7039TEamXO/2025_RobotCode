...
public class TrayConstants {
    ...
    public static final double kS = 0.05; // Add 0.25 V output to overcome static friction
    ...
    public static final double kP = 3; // A position error of 2.5 rotations results in 12 V output
    ...
    public static final double MotionMagicCruiseVelocity = 50; // Target cruise velocity of 80 rps
    public static final double MotionMagicAcceleration = 50; // Target acceleration of 160 rps/s (0.5 seconds)
    ...
    public static final double TRAY_POS_UP = 1.20; // CHANGE [!]
    public static final double TRAY_MAX_POSE = 1.25;
}
